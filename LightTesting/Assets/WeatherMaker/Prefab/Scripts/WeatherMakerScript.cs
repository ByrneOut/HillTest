    ...
    public class WeatherMakerScript : MonoBehaviour
    {
        ...
        private void SetGlobalShaders()
        {
            if (Sun != null)
            {
                ...
                Shader.SetGlobalVector("_WeatherMakerSunQuaternion", new Vector4(Sun.Transform.rotation.x, Sun.Transform.rotation.y, Sun.Transform.rotation.z, Sun.Transform.rotation.w));
