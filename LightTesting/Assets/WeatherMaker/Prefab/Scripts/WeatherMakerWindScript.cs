...
namespace DigitalRuby.WeatherMaker
{
    public class WeatherMakerWindScript : MonoBehaviour
    {
        ...
        [Tooltip("Additional intensity multiplier. Set to 0 to disable wind.")]
        [Range(0.0f, 10.0f)]
        ...
        private void UpdateWind()
        {
            ...
            if (WindIntensity > 0.0f && ExternalIntensityMultiplier > 0.0f &&
                MaximumWindSpeed > 0.0f && WindMainMultiplier > 0.0f)
            {
                WindZone.windMain = MaximumWindSpeed * WindIntensity * WindMainMultiplier * ExternalIntensityMultiplier;
