    ...
    SubShader
	{
        ...
        Pass
		{
            ...
            v2f vert(appdata_t v)
            {
				...
				o.color.rgb = CalculateLightColorWorldSpace(WorldSpaceVertexPos(v.vertex), diffuseColor, _WeatherMakerAmbientLightColorGround, 1).rgb;
			...
			{       
				...
				color.rgb = CalculateLightColorWorldSpace(i.worldPos, color.rgb, _WeatherMakerAmbientLightColorGround, 0).rgb;
				color.a *= i.color.a;
